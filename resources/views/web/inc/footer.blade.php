            ...
            <div class="row y-gap-30">
                ...
                <div class="col-xl-4 col-lg-8">
                    ...
                    <div class="row justify-between y-gap-20">
                        <div class="col-md-6">
                            <div class="d-flex y-gap-10 flex-column">
                                <a href="appointments-single-1.html">Development</a>
                                <a href="appointments-single-2.html">Business</a>
                                <a href="appointments-single-3.html">Finance & Accounting</a>
                                <a href="appointments-single-4.html">IT & Software</a>
                                <a href="appointments-single-5.html">Office Productivity</a>
                                <a href="appointments-single-6.html">Design</a>
                                <a href="appointments-single-1.html">Marketing</a>
                            </div>
                        </div>

                        <div class="col-md-6">
                            <div class="d-flex y-gap-10 flex-column">
                                <a href="appointments-single-1.html">Lifiestyle</a>
                                <a href="appointments-single-2.html">Photography & Video</a>
                                <a href="appointments-single-3.html">Health & Fitness</a>
                                <a href="appointments-single-4.html">Music</a>
                                <a href="appointments-single-5.html">UX Design</a>
                                <a href="appointments-single-6.html">Seo</a>
                            </div>
                        </div>
                    </div>
                </div>
