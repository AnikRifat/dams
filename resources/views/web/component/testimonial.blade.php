                ...
                <div class="swiper-slide">
                    <div data-anim-child="slide-left delay-1" class="testimonials -type-1">
                        <div class="testimonials__content">
                            ...
                            <p class="testimonials__text"> “I think Educrat is the best theme I ever seen
                                this year. Amazing design, easy to customize and a design quality
                                superlative account on its cloud platform for the optimized performance”</p>

                            <div class="testimonials-footer">
                                <div class="testimonials-footer__image">
                                    <img src="{{ asset('') }}assets/web/img/testimonials/1.png" alt="image">
                                </div>
                ...
                <div class="swiper-slide">
                    <div data-anim-child="slide-left delay-2" class="testimonials -type-1">
                        <div class="testimonials__content">
                            ...
                            <div class="testimonials-footer">
                                <div class="testimonials-footer__image">
                                    <img src="{{ asset('') }}assets/web/img/testimonials/2.png" alt="image">
                                </div>
                ...
                <div class="swiper-slide">
                    <div data-anim-child="slide-left delay-3" class="testimonials -type-1">
                        <div class="testimonials__content">
                            ...
                            <div class="testimonials-footer">
                                <div class="testimonials-footer__image">
                                    <img src="{{ asset('') }}assets/web/img/testimonials/3.png" alt="image">
                                </div>
                ...
                <div class="swiper-slide">
                    <div data-anim-child="slide-left delay-4" class="testimonials -type-1">
                        <div class="testimonials__content">
                            ...
                            <div class="testimonials-footer">
                                <div class="testimonials-footer__image">
                                    <img src="{{ asset('') }}assets/web/img/testimonials/4.png" alt="image">
                                </div>
        ...
        <div data-anim-wrap class="row y-gap-30 counter__row">
            ...
            <div class="col-lg-3 col-sm-6">
                <div data-anim-child="slide-left delay-1" class="counter -type-1">
                    ...
                    <div class="counter__title">Patients worldwide</div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <div data-anim-child="slide-left delay-2" class="counter -type-1">
                    ...
                    <div class="counter__title">Total appointment views</div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <div data-anim-child="slide-left delay-3" class="counter -type-1">
                    ...
                    <div class="counter__title">Five-star appointment reviews</div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <div data-anim-child="slide-left delay-4" class="counter -type-1">
                    ...
                    <div class="counter__title">Patients community</div>
                </div>
            </div>
