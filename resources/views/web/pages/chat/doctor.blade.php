                    ...
                    <div class="row y-gap-20">
                        ...
                        <div class="col-xl-7 col-lg-10">
                            <div class="d-flex items-center">
                                <div class="shrink-0">
                                    ...
                                    $patientInfo = App\Models\User::find($chat->sender_id);

                                    @endphp
                                    <img src="{{ asset('') }}uploads/patients/{{ $patientInfo->patient->image }}"
                                      alt="image" class="size-50">
                                </div>
                                <div class="lh-11 fw-500 text-dark-1 ml-10">{{ $patientInfo->name }}</div>
                        ...
                        <div class="col-xl-7 offset-xl-5 col-lg-10 offset-lg-2">
                            <div class="d-flex items-center justify-end">
                                ...
                                <div class="shrink-0">
                                    <img src="{{ asset('uploads/doctors/'.Auth::user()->doctor->image) }}" alt="image"
                                      class="size-50">
                                </div>
                            </div>
                            <div class="d-block mt-15">
